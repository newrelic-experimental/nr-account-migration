...
class USEndpoints:
    ...
    SYNTH_LOCATIONS_URL = 'https://synthetics.newrelic.com/synthetics/api/v1/locations'
...
class EUEndpoints:
    ...
    SYNTH_LOCATIONS_URL = 'https://synthetics.eu.newrelic.com/synthetics/api/v1/locations'
